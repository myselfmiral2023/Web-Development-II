...
import { create, findAll, findOne, update, remove, findAllAvailable, findOneAvailable } from "../controllers/vehicle.controller.js";

const router = express.Router();

router.get("/", findAll);
router.get("/available/:startDate/:endDate", findAllAvailable);
router.get("/available/:startDate/:endDate/:id", findOneAvailable);
